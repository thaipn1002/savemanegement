...
namespace CPC.POSReport.ViewModel
{
    class FilterReportViewModel : ModelBase
    {
        ...
        private void GetAllProduct()
        {
            ...
            productCollection = new ObservableCollection<base_ProductModel>(
                productRepo.GetAll().Select(p => new base_ProductModel(p))
                .OrderBy(o => o.ProductName)
                );
            ProductModelCollection = productCollection;
            base_ProductModel product = CreateProduct();
            ProductModelCollection.Insert(0, product);
            ProductModel = product;
        }
