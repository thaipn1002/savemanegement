...
namespace CPC.POSReport.ViewModel
{
    class LoginViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        private void LoginExecute()
        {
            ...
            {                               
                ...
                if (resuilt)
                {
                    ...
                    // Get keep log
                    var keepLog = configRepo.Get(x => x.Id > 0).KeepLog;
                    if (keepLog != null)
                    {
                        Common.KEEP_LOG = (short)keepLog;
                    }
                }
                else
                {                    
        ...
        private void SetFullRight()
        {
            ...
            Common.VIEW_HISTORY_PRINTED = true;
            Common.ADD_USER = true;
            Common.EDIT_USER = true;
            Common.DELETE_USER = true;
