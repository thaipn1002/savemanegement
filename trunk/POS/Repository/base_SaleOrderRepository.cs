...
namespace CPC.POS.Repository
{
    ...
    public partial class base_SaleOrderRepository
    {
        ...
        public void GetProductUOMforSaleOrderDetail(CPC.POS.Model.base_SaleOrderDetailModel salesOrderDetailModel, bool SetPrice = true)
        {
            ...
            UnitOfWork.Refresh<base_ProductStore>(salesOrderDetailModel.ProductModel.base_Product.base_ProductStore);
        ...
        ///// </summary>
        ///// <param name="saleOrderModel"></param>
        //public decimal CalcShipTaxAmount(CPC.POS.Model.base_SaleOrderModel saleOrderModel)
        //{
        ...
        //    {
        //        CPC.POS.Model.base_SaleTaxLocationModel shippingTaxCode = new Model.base_SaleTaxLocationModel(UnitOfWork.Get<base_SaleTaxLocation>(x => x.Id.Equals(saleOrderModel.TaxLocationModel.ShippingTaxCodeId)));
        ...
        /// Apply Tax
        /// </summary>
        public decimal CalculateReturnTax(base_ResourceReturnModel returnModel, base_SaleOrderModel saleOrderModel)
        {
            decimal result = 0;
            if (saleOrderModel.TaxLocationModel.TaxCodeModel != null)
            {
