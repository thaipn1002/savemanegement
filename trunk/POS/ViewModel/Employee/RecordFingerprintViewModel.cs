    ...
    public class RecordFingerprintViewModel : ViewModelBase, DPFP.Capture.EventHandler
    {
        ...
        private void LoadExecute(object param)
        {
            ...
            catch (DllNotFoundException ex)
            {
                _log4net.Error(ex);
                this.IsError = true;
                MsgControl.ShowWarning(ex.Message.ToString(), "Warning", MessageBoxControl.MessageBoxButtonCustom.OK);
        ...
        protected void Stop()
        {
            ...
            {
                _log4net.Error(ex);
                MsgControl.ShowWarning(ex.Message.ToString(), "Thông báo", MessageBoxControl.MessageBoxButtonCustom.OK);
            }
        }
