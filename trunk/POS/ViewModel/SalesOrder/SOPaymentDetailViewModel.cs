...
{
    class SOPaymentDetailViewModel : ViewModelBase, IDataErrorInfo
    {
        #region Define
        ...
        #region Constructors
        public SOPaymentDetailViewModel()
        {
            _ownerViewModel = this;
            this.InitialCommand();
        }
        public SOPaymentDetailViewModel(base_ResourcePaymentModel value)
        {
            _ownerViewModel = this;
            this.InitialCommand();
            this.ResourcePaymentModel = value;
            value.EndUpdate();
            this.ResourcePaymentModel.EndUpdate();
        }
        #endregion
        ...
        #region ResourcePaymentModel
        private base_ResourcePaymentModel _resourcePaymentModel;
        /// <summary>
        /// Gets or sets the ResourcePaymentModel.
        /// </summary>
        public base_ResourcePaymentModel ResourcePaymentModel
        {
            get { return _resourcePaymentModel; }
            set
            {
                if (_resourcePaymentModel != value)
                {
                    _resourcePaymentModel = value;
                    OnPropertyChanged(() => ResourcePaymentModel);
                }
            }
        }
        #endregion
        ...
        {
            return (this.ResourcePaymentModel != null && this.ResourcePaymentModel.IsDirty);
        }
        ...
        {
            base_ResourcePaymentRepository PaymentDetailRepository = new base_ResourcePaymentRepository();
            base_ResourcePayment ResourcePaymentDetail = PaymentDetailRepository.GetAll(x => x.Id == this.ResourcePaymentModel.Id).SingleOrDefault();
            ResourcePaymentDetail.DateCreated = this.ResourcePaymentModel.DateCreated;
            ResourcePaymentModel.UserCreated = Define.USER.UserName;
            this.ResourcePaymentModel.UserCreated = Define.USER.UserName;
            PaymentDetailRepository.Commit();
            this.ResourcePaymentModel.EndUpdate();
