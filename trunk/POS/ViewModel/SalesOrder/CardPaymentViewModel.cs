...
namespace CPC.POS.ViewModel
{
    ...
    class CardPaymentViewModel : ViewModelBase, IDataErrorInfo
    {
        ...
        {
            return IsCardValid == true && IsValid && PaymentMethodModel.CouponCardModel != null;
        }
        ...
        private void OnValidateCardNumberCommandExecute(object param)
        {
            ...
            int cardTypeId = Convert.ToInt32(this.PaymentMethodModel.PaymentMethodId);
            IQueryable<base_CardManagement> query = _cardManagementRepository.GetIQueryable(x => !x.IsPurged && x.IsSold && x.CardTypeId.Equals(cardTypeId) && x.CardNumber.Equals(CardNumber));
