    ...
    class ChangePasswordViewModel : ViewModelBase
    {
        ...
        private void OnOkCommandExecute()
        {
            if (ResourceAccountModel.NewPassword.Equals(ResourceAccountModel.NewConfirmPassword))
            {
                ...
                {
                    MsgControl.ShowWarning("Mật khẩu cũ không đúng.Cui lòng nhập lai.", "Cảnh báo", MessageBoxButtonCustom.OK);
                }
            }
            else
            {
                MsgControl.ShowWarning("Mật khẩu xác nhận không đúng.Cui lòng nhập lai.", "Cảnh báo", MessageBoxButtonCustom.OK);
            }
        }
