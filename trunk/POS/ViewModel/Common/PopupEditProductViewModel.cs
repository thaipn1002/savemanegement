...
namespace CPC.POS.ViewModel
{
    class PopupEditProductViewModel : ViewModelBase
    {
        ...
        public bool IsEditPromotion
        {
            get
            {
                return SelectedProductUOM.UOMId.Equals(SelectedProduct.BaseUOMId);
            }
        }
        ...
        /// <summary>
        /// Constructor use for SO
        /// </summary>
        /// <param name="productModel"></param>
        /// <param name="priceSchemaId"></param>
        /// <param name="isEditUOM"></param>
        /// <param name="promotionID"></param>
        public PopupEditProductViewModel(base_ProductModel productModel, PriceTypes priceSchemaId, bool isEditUOM, int promotionID, bool isEditPromotion = false)
            : this(productModel, isEditUOM)
        {
            _priceSchemaID = priceSchemaId;

            IsEditFromPO = !isEditPromotion;
            if (isEditPromotion)
            {
        ...
        /// <summary>
        /// Constructor use for PO
        /// </summary>
        /// <param name="productModel"></param>
        /// <param name="isEditFromPO"></param>
        /// <param name="isEditUOM"></param>
        ...
        private void OnSelectedProductUOMChanged()
        {
            ...
            if (!IsEditPromotion && PromotionCollection != null)
            {
