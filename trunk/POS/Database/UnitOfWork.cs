...
namespace CPC.POS.Database
{
    public sealed class UnitOfWork : IDisposable
    {
        ...
        /// <typeparam name="T">Type of object in a sequence.</typeparam>
        /// <returns>
        /// An new System.Data.Objects.ObjectSet<T> instance.
        /// </returns>
        public static ObjectSet<T> GetObjectSet<T>() where T : class
        {
            return _objectContext.CreateObjectSet<T>();
        }
        ...
        /// <summary>
        /// Take a few objects in sequence was sorted by ascending on server
        /// </summary>
        /// <typeparam name="T">Type of object in a sequence.<</typeparam>
        ...
        {
            return _objectContext.CreateObjectSet<T>().OrderBy(keySelector).Skip(ignoreCount).Take(takeCount).ToList();
        }
        ...
        {
            return (_objectContext.CreateObjectSet<T>().OrderBy(keySelector).Where(expression)).Skip(ignoreCount).Take(takeCount).ToList();
        }
        ...
        /// <param name="keySelector">The key columns by which to order the results.</param>
        /// <returns>The new IList<T> instance.</returns>
        public static IList<T> GetRangeDescending<T, TKey>(int ignoreCount, int takeCount, Expression<Func<T, TKey>> keySelector) where T : class
        {
        ...
        /// <param name="expression">A function to test each object for a condition.</param>
        /// <returns>The new IList<T> instance.</returns>
        public static IList<T> GetRangeDescending<T, TKey>(int ignoreCount, int takeCount, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>> expression) where T : class
        {
        ...
        /// <summary>
        /// Reload object context with new connection string
        /// </summary>
