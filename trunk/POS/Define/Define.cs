...
namespace CPC.POS
{
    public sealed class Define
    {
        static Define()
        {
            ...
            DirectoryInfo dataFolder = directoryExecuting.GetDirectories("Language").FirstOrDefault();
            if (dataFolder != null)
            {
                FileInfo contentHappyBirthdayFileInfo = dataFolder.GetFiles("ContentHappyBirthday-en-US.txt").FirstOrDefault();
                if (contentHappyBirthdayFileInfo != null)
                {
                    Define.ContentHappyBirthdayFile = contentHappyBirthdayFileInfo.FullName;
                }
            }
        }
        ...
        public static bool IsOpenLiability { get; set; }
        /// <summary>
        ...
        //Default ShiftCode 
        public static string ShiftCode = CPC.POS.Properties.Settings.Default.Shift;
