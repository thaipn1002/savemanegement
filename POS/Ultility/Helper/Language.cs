...
namespace CPC.Helper
{
    public class Language
    {
        ...
        /// <summary>
        /// Gets the Ribbon_Create string
        /// </summary>
        public static string RibbonCreate
        {
            get
            {
                return Application.Current.FindResource("Ribbon_Create") as string;
            }
        }

        /// <summary>
        /// Gets the Ribbon_List string
        /// </summary>
        public static string RibbonList
        {
            get
            {
                return Application.Current.FindResource("Ribbon_List") as string;
            }
        }

        /// <summary>
        /// Gets the Ribbon_GroupEmpoyee string
        /// </summary>
        public static string RibbonGroupEmpoyee
        {
            get
            {
                return Application.Current.FindResource("Ribbon_GroupEmpoyee") as string;
            }
        }

        /// <summary>
        /// Gets the Ribbon_GroupSales string
        /// </summary>
        public static string RibbonGroupSales
        {
            get
            {
                return Application.Current.FindResource("Ribbon_GroupSales") as string;
            }
        }

        /// <summary>
        /// Gets the Ribbon_GroupStores string
        /// </summary>
        public static string RibbonGroupStores
        {
            get
            {
                return Application.Current.FindResource("Ribbon_GroupStores") as string;
            }
        }
