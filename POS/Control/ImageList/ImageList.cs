...
namespace CPC.Control
{
    ...
    public class ImageControl : ListBox
    {
        ...
        /// <summary>
        /// Gets or sets a value that indicates whether the user can add, delete or change images in the ImageControl.
        /// </summary>
        public bool IsReadOnly
        {
            get
        ...
        public static readonly DependencyProperty IsReadOnlyProperty =
            DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(ImageControl), new UIPropertyMetadata(false, IsReadOnlyChanged));

        public static void IsReadOnlyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ImageControl imageList = d as ImageControl;
        ...
        /// <summary>
        /// Gets or sets a value that indicates whether the user can arrange images in the ImageControl.
        /// </summary>
        public bool CanUserArrangeImage
        {
            get
        ...
        public static readonly DependencyProperty CanUserArrangeImageProperty =
            DependencyProperty.Register("CanUserArrangeImage", typeof(bool), typeof(ImageControl), new UIPropertyMetadata(true, CanUserArrangeImageChanged));
        ...
        // Using a DependencyProperty as the backing store for MaxNumberOfImage.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty MaxNumberOfImagesProperty =
            DependencyProperty.Register("MaxNumberOfImages", typeof(int), typeof(ImageControl), new UIPropertyMetadata(1));
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (_listBox != null)
            {
                ...
                binding.Mode = BindingMode.TwoWay;
                binding.UpdateSourceTrigger = UpdateSourceTrigger.PropertyChanged;
                binding.RelativeSource = new RelativeSource(RelativeSourceMode.FindAncestor, typeof(ImageControl), 1);
                _listBox.SetBinding(ListBox.ItemsSourceProperty, binding);
        ...
        private void _gridImage_MouseMove(object sender, MouseEventArgs e)
        {
            //To check that active and inactive button.
            this._buttonChange.Visibility = Visibility.Collapsed;
            this._buttonRemove.Visibility = Visibility.Collapsed;
        ...
        private void SelectCurrentImage(object item)
        {
            if (item != null)
            {
                ...
                {
                    byte[] imageBinary = this.GetPropertyValue(item, this.DisplayMemberPath) as byte[];
                    BitmapImage bitmapImage = this.ConvertByteToImageSource(imageBinary);
                    if (bitmapImage != null)
                    {   // Show current image.
                        if (this._image != null)
        ...
        /// <returns></returns>
        private BitmapImage ConvertByteToImageSource(byte[] value)
        {
            try
            {
        ...
        private void ListBoxSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            this.SelectCurrentImage(_listBox.SelectedItem);
        }
        private void ListBoxLoaded(object sender, RoutedEventArgs e)
        {
            if (_listBox.ItemsSource != null)
        ...
        private void SetVisibleImageControl()
        {
            this._gridContentImage = GetTemplateChild("PART_GRIDLISTBOX") as Grid;
            if (this._gridContentImage != null)
            {
