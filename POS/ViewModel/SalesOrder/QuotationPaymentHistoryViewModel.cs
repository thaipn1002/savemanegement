...
namespace CPC.POS.ViewModel
{
    class QuotationPaymentHistoryViewModel : ViewModelBase
    {
        ...
        private bool OnRefundCommandCanExecute(object param)
        {
            if (SaleOrderModel == null)
                return false;
            return SaleOrderModel.Deposit > 0 && (SaleOrderModel.OrderStatus.Equals((short)SaleOrderStatus.Quote) || SaleOrderModel.OrderStatus.Equals((short)SaleOrderStatus.Layaway));
        }
