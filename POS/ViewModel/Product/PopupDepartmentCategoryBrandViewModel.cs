...
namespace CPC.POS.ViewModel
{
    public class PopupDepartmentCategoryBrandViewModel : ViewModelBase
    {
        ...
        /// </summary>
        /// <param name="location">ProductDeparmentLevel is department, category, or brand.</param>
        /// <param name="parentID">Parent base_DepartmentModel's Id.</param>
        public PopupDepartmentCategoryBrandViewModel(ProductDeparmentLevel location, int? parentID)
        {
        ...
        private void Save()
        {
            ...
            catch (Exception exception)
            {
                ...
                MsgControl.ShowWarning(exception.Message, "Thông báo", MessageBoxButtonCustom.OK);
            }
        }
        ...
        private void InitializeNewItem(int? parentID)
        {
            switch (_currentLocation)
            {
                case ProductDeparmentLevel.Department:
                    ...
                    {
                        ParentId = null,
                        LevelId = (short)ProductDeparmentLevel.Department,
                        IsActived = true,
                        IsNew = true,
                        IsDirty = false
                    };
                ...
                case ProductDeparmentLevel.Category:
                    ...
                    NewItem = new base_DepartmentModel
                    {
                        ...
                        LevelId = (short)ProductDeparmentLevel.Category,
                        IsActived = true,
                        IsNew = true,
                        IsDirty = false
                    };
                ...
                case ProductDeparmentLevel.Brand:
                    ...
                    {
                        ParentId = parentID,
                        LevelId = (short)ProductDeparmentLevel.Brand,
                        IsActived = true,
                        IsNew = true,
                        IsDirty = false
                    };
