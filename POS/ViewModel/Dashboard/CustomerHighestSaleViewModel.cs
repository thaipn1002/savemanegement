...
{
    public class CustomerHighestSaleViewModel : ViewModelBase, IDashboardItemFunction
    {
        #region Fields
        ...
        public CustomerHighestSaleViewModel(Grid grid, XElement configuration)
        {
            _gridView = grid;
        ...
        private void GetSaleOrders()
        {
            try
            {
                ...
                string query = string.Format(
                    "Select \"CustomerResource\", \"Customer\", Sum(\"SubTotal\") as \"SubTotal\" From v_sale_order_summary " +
                ...
                _chartBase.ChartTitle = string.Format("Top {0} Customer With Highest Sale", _total);
